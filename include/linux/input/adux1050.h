...
//#define USE_TRANCEBLITY
#define FUNCTION_WHILE_SLEEP
...
*/
#define PSENSOR_DRIVER_NAME			"adux1050_generic"
/**
...
struct adux1050_chip {
    ...
    //struct input_dev *input;		///* [PLATFORM]-Removed by TCTSZ.lizhi.wu, 2014.12.30*/
    ...
    */
    ...
    struct delayed_work data_monitor_work;
    struct delayed_work env_calib_work;
    u8 env_calib_count;
    u8 is_env_calib;
    u32 result_ave;
#ifdef FUNCTION_WHILE_SLEEP
    struct wake_lock adux1050_wakelock;
#endif
